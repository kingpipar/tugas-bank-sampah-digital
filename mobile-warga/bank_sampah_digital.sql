...
--
-- Host: localhost
-- Generation Time: May 24, 2026 at 11:51 AM
...
CREATE TABLE `request_jemput` (
  ...
  `estimasi_kantong` int DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `request_jemput` (`id`, `nama_warga`, `alamat`, `jenis_sampah`, `estimasi_berat`, `tanggal_jemput`, `catatan`, `status`, `created_at`, `user_id`, `estimasi_kantong`) VALUES
(3, 'Warga Baru', 'Alamat pengguna', 'Campuran', 5.00, '2026-05-19', 'asda', 'Menunggu', '2026-05-19 11:08:29', 8, 1),
(4, 'Warga Baru', 'Alamat pengguna', 'Campuran', 5.00, '2026-05-24', 'plastik', 'Menunggu', '2026-05-24 09:52:18', 9, 1),
(5, 'Warga Baru', 'Alamat pengguna', 'Campuran', 3.00, '2026-05-24', 'kertas', 'Menunggu', '2026-05-24 09:52:53', 9, 1),
(6, 'Warga Baru', 'Alamat pengguna', 'Campuran', 6.00, '2026-05-24', 'kertas', 'Menunggu', '2026-05-24 09:56:45', 9, 1),
(7, 'Warga Baru', 'Alamat pengguna', 'Campuran', 7.00, '2026-05-24', 'kertas', 'Menunggu', '2026-05-24 09:58:26', 9, 1),
(8, 'Warga Baru', 'Alamat pengguna', 'Campuran', 5.00, '2026-05-24', 'ada', 'Menunggu', '2026-05-24 10:17:46', 9, 5),
(9, 'Warga Baru', '-7.782405, 110.415952', 'Campuran', 5.00, '2026-05-24', 'iaugds', 'Menunggu', '2026-05-24 10:28:25', 9, 1),
(10, 'Warga Baru', '-7.782404, 110.415954', 'Campuran', 6.00, '2026-05-24', 'zaz', 'Menunggu', '2026-05-24 11:42:18', 10, 1);
...
CREATE TABLE `transaksi` (
  ...
  `jumlah_poin` decimal(12,2) NOT NULL,
  `keterangan` text,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `users` (
  ...
  `saldo_poin` decimal(12,2) NOT NULL DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `created_at`, `firebase_uid`, `saldo_poin`) VALUES
(1, 'Admin', 'admin@gmail.com', 'admin123', 'admin', '2026-05-12 08:27:55', NULL, 0.00),
(2, 'Budi', 'test@test.com', NULL, 'warga', '2026-05-19 06:00:06', '123', 0.00),
(3, 'Warga Baru', 'testsatu@banksampah.com', NULL, 'warga', '2026-05-19 06:13:21', 'yvTHkW9HDrXEgOpfhNKAz75OeHn2', 0.00),
(4, 'Warga Baru', 'warga@banksampah.com', NULL, 'warga', '2026-05-19 08:49:55', 'kwZMsY82qIP4tgfhDppCaDqy6iM2', 0.00),
(5, 'Warga Baru', 'testdua@banksampah.com', NULL, 'warga', '2026-05-19 09:42:24', 'w5hCj8ILlmVKcYQxt20irPRERMv2', 0.00),
(6, 'Warga Baru', 'tes@sampah.com', NULL, 'warga', '2026-05-19 10:00:55', 'tVrNuTLtfQTpTK4kSaxIsTIlrZu1', 0.00),
(7, 'Warga Baru', 'tes1@sampah.com', NULL, 'warga', '2026-05-19 10:08:38', 'VkieUOvOGdO88xEqO7lYgW0w6kB2', 0.00),
(8, 'Warga Baru', 'tes2@sampah.com', 'tes123', 'warga', '2026-05-19 10:11:21', 'RAr64yrMF9NLEvCLx6BthvOi4Bq2', 0.00),
(9, 'Warga Baru', 'tes3@gmail.com', 'tes123', 'warga', '2026-05-19 10:16:13', 'jmHsUg10JfZWFHLxDf3qVL9AFoo1', 0.00),
(10, 'Warga Baru', 'tes4@banksampah.com', 'tes123', 'warga', '2026-05-24 10:37:35', 'YaBlIDyDAlRw8oCe3IKSOm9VzHH3', 0.00);
